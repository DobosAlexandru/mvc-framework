        ...
        <div class="relative flex w-full max-w-xs flex-1 flex-col bg-indigo-700 pt-5 pb-4">
            ...
            <div class="mt-5 h-0 flex-1 overflow-y-auto">
                <nav class="space-y-1 px-2">
                    ...
                    <a href="#"
                        class="text-indigo-100 hover:bg-blue-600 group flex items-center px-2 py-2 text-base font-medium rounded-md">
    ...
    <div class="flex flex-grow flex-col overflow-y-auto bg-blue-800 pt-5">
        ...
        <div class="mt-5 flex flex-1 flex-col">
            <nav class="flex-1 space-y-1 px-2 pb-4">
                ...
                <a href="#"
                    class="bg-blue-900 text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                ...
                <a href="#"
                    class="text-indigo-100 hover:bg-blue-600 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
